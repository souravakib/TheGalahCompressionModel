...
# Configuration
CONFIG = {
    'latent_dims': [16, 32, 64, 128, 256],  # Match CNN AE latent dimensions
    ...
    'early_stopping_patience': 10,  # Match CNN AE patience
    'base_output_dir': './results/variational_autoencoder',
...
class VAEDataset(Dataset):
    ...
    def __init__(self, csv_path, spectra_dir, n_spectra=None):
        ...
        # Create common wavelength grid dynamically like CNN AE
